...
<h1 align="center">Fiber API Boilerplate</h1>

<p align="center">
  A Fiber HTTP service in Go, ready to deploy on Light Cloud.
</p>
...
- Fiber v2 on fasthttp
- JSON responses with Fiber's router and middleware
...
3. Choose **"Fiber"** as the framework
